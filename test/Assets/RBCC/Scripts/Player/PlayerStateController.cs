...
namespace RBCC.Scripts.Player
{
    public class PlayerStateController : MonoBehaviour
    {
        ...
        private void HandleHorizontalMovement()
        {
            ...
            Vector3 horizontalVel = Vector3.ProjectOnPlane(_rb.linearVelocity, UpDirection);
            ...
            _targetVelocity = Vector3.MoveTowards(
                _rb.linearVelocity, // TODO: understand why put targetVelocity and not RB here. Hint: for wallJump it has to be rb.velocity so the velocities are synchronised.
        ...
        {
            Vector3 hvel = Vector3.ProjectOnPlane(_rb.linearVelocity, UpDirection);
